...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white font-sans selection:bg-purple-100">
        ...
        <div className="relative z-20 space-y-6">
          ...
          >
            <h2 className="text-4xl xl:text-5xl font-black tracking-tighter text-zinc-900 leading-[0.95] mb-6">
              Build the future <br /> 
              <span className="text-purple-600">without limits.</span>
            </h2>
            <p className="text-zinc-500 text-base font-bold max-w-xs leading-relaxed">
              Access multi-million token context windows and the world's most advanced AI models via a single protocol.
            </p>
          </motion.div>
      ...
      {/* RIGHT SIDE - Larger Form Area (flex-1) */}
    ...
    Secure Authentication by Supabase
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="group w-full bg-[#202124] text-white font-black py-5 rounded-2xl hover:bg-black transition-all shadow-xl active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed uppercase text-xs tracking-[0.3em] flex items-center justify-center gap-2"
            >
              {loading ? "Authenticating..." : "Login"}
              {!loading && <Zap size={14} className="fill-white" />}
            </button>
          </div>

          <div className="flex flex-col items-center gap-4">
            <button onClick={handleForgotPassword} className="text-[10px] font-black uppercase tracking-widest text-zinc-400 hover:text-zinc-900 transition-all">
