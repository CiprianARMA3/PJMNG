...
const FloatingIcons = () => {
  ...
  useEffect(() => {
    ...
    // Swapped Blue for Purple in the color array
    const brandColors = ['#a855f7', '#EA4335', '#FBBC04', '#34A853'];
    ...
    const newItems = Array.from({ length: 18 }).map((_, i) => {
      ...
      const maxCenterOffset = 18; 
      const minEdgeOffset = 2;    
...
const ParticleBackground = () => {
  ...
  useEffect(() => {
    ...
    // Updated colors to include purple shades
    const colors = ['#a855f7', '#d8b4fe', '#FBBC04', '#34A853', '#5f6368', '#dadce0'];

    class Particle {
      x: number; y: number; size: number; speedX: number; speedY: number; color: string; originalX: number; originalY: number;
    ...
    >
      <div className="max-w-[1400px] mx-auto h-full flex items-center justify-between">
        <div className="flex items-center gap-1 cursor-pointer z-50">
          <span className="text-2xl font-normal tracking-tight">KAPR<span className="text-purple-500 font-normal">Y</span></span>
              ...
              <div className="absolute top-[60px] -left-10 w-[600px] p-6 bg-white rounded-2xl shadow-2xl border border-gray-100 grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2 z-40">
                {productLinks.map((item) => (
                  <a key={item.name} href="#" className="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group/item">
                    {/* Changed bg-blue-50 to bg-purple-50 and text-[#1a73e8] to text-purple-600 */}
    ...
    <div className="relative z-10 max-w-4xl mx-auto space-y-10 animate-fade-in-up">
      <div className="flex justify-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full shadow-sm hover:shadow-md transition-shadow cursor-default">
          <div className="relative flex items-center justify-center">
            ...
            <span className="absolute w-2 h-2 bg-green-500 rounded-full animate-pulse" aria-hidden="true"></span>
          </div>
      ...
      <div className="pt-8 animate-fade-in -mt-6">
        <div className="inline-flex items-center gap-2 px-5 py-2 ">
          ...
          <img src="https://freepnglogo.com/images/all_img/1728457808_Google_Gemini_logo_PNG.png" className='w-30 mt-2 inline-block ml-2' alt="Gemini" />
...
const FeatureCard = ({ icon: Icon, title, text }: { icon: any, title: string, text: string }) => (
  // Changed gradients and hover colors to purple
              ...
              <div className="space-y-4 mb-8">
                {plan.features.map((feature, i) => (
                  <div key={i} className="flex items-start gap-3">
                    {/* Updated checkmark colors to Purple/Green mix */}
...
const Footer = () => (
  <footer className="py-12 px-6 bg-white relative z-10">
    <div className='flex justify-center align-center text-[10vw] md:text-[175px] font-extrabold leading-none select-none'> 
      <p>KAPRY.DEV</p>
    </div>
    <div className='flex justify-center align-center mb-25 text-xl md:text-5xl font-bold  text-center mt-4 leading-none select-none'> 
