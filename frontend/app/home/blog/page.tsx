...
const AuroraBackground = () => {
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none bg-white">
      ...
      <div className="absolute bottom-[-10%] left-[20%] w-[60vw] h-[50vh] bg-indigo-50/60 rounded-full blur-[160px] mix-blend-multiply" style={{ animation: 'sine-flow-3 18s infinite ease-in-out' }} />
      <div className="absolute inset-0 opacity-[0.12] pointer-events-none" style={{ backgroundImage: "url('/grainy.png')", backgroundRepeat: 'repeat', backgroundSize: '120px 120px', mixBlendMode: 'multiply', filter: 'blur(3px)' }} />
