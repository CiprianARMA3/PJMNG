...
export default function MissingSubscriptionPage() {
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-[#0C0C0E] border border-red-900/30 rounded-2xl p-8 text-center shadow-2xl relative overflow-hidden">
        ...
        <div className="bg-red-950/20 border border-red-900/50 rounded-lg p-4 mb-8 text-left flex gap-3">
          <AlertTriangle className="text-red-500 shrink-0 mt-0.5" size={20} />
          <div className="text-sm text-red-200/80">
            <span className="font-bold text-red-200">Warning:</span> If the subscription is not renewed within <strong>15 days</strong> of expiration, this project and its data may be permanently deleted.
          </div>
        </div>
