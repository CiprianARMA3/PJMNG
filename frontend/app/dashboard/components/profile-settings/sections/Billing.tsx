            ...
            <PageWidget title="Subscription Management" icon={TrendingUp}>
                {subscriptionData && hasRelevantSubscription ? (
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-10 text-sm">
                            ...
                            <div className="space-y-1 col-span-2">
                                ...
                                <p className="font-mono text-xs text-neutral-400 light:text-neutral-600 bg-[#161616] light:bg-gray-50 py-1.5 px-3 rounded border border-[#222] light:border-gray-200 inline-block ml-5">
                                    {subscriptionData.id}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="py-12 flex flex-col items-center text-center">
                        ...
                        <Link href="/pricing" className="px-5 py-2 text-sm font-semibold bg-white light:bg-black text-black light:text-white rounded-lg hover:bg-neutral-200 light:hover:bg-neutral-800 transition-colors">
                            View Plans
                        </Link>
                    </div>
                )}
