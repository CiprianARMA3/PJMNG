    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 font-sans">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-xl font-medium text-white/90 mb-1">Legal & Compliance</h1>
                    <p className="text-sm text-neutral-500">View your signed agreements and manage your data rights.</p>
                </div>
                <div className="flex items-center gap-2 px-3 py-1.5 bg-[#161616] border border-[#222] rounded-lg">
                    <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                    <span className="text-xs text-neutral-400 font-medium">Account in Good Standing</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* EU / GDPR Card */}
                <div className="bg-gradient-to-b from-[#161616] to-[#111] border border-[#222] rounded-xl p-6 relative overflow-hidden group hover:border-blue-900/30 transition-colors">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-sm font-medium text-white">EU Data Protection</h3>
                            </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between text-xs py-2 border-t border-[#222]">
                                ...
                                <span className="text-neutral-200">Frankfurt (eu-central-1)</span>
                            </div>
                            <div className="flex items-center justify-between text-xs py-2 border-t border-[#222]">
                                <span className="text-neutral-400 flex items-center gap-2">
                                    <FileCheck size={12} />
                        ...
                        <div className="mt-6 pt-4 border-t border-[#222] flex gap-3">
                            <button 
                                ...
                                className="flex-1 py-2 text-xs font-medium bg-[#1a1a1a] hover:bg-[#222] text-neutral-300 hover:text-white border border-[#2a2a2a] rounded-lg transition-colors flex items-center justify-center gap-2"
                            >
                ...
                {/* US / CCPA Card */}
                <div className="bg-gradient-to-b from-[#161616] to-[#111] border border-[#222] rounded-xl p-6 relative overflow-hidden group hover:border-green-900/30 transition-colors">
                    <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.06] transition-opacity">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-sm font-medium text-white">US Privacy Standards</h3>
                            </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between text-xs py-2 border-t border-[#222]">
                                ...
                                <span className="text-neutral-200">AES-256 (At Rest)</span>
                            </div>
                            <div className="flex items-center justify-between text-xs py-2 border-t border-[#222]">
                                <span className="text-neutral-400 flex items-center gap-2">
                                    <FileText size={12} />
                                ...
                                <a href="#" className="text-neutral-300 hover:text-white underline decoration-neutral-700">View List</a>
                            </div>
                        </div>

                        <div className="mt-6 pt-4 border-t border-[#222] flex gap-3">
                             <button className="flex-1 py-2 text-xs font-medium bg-[#1a1a1a] hover:bg-[#222] text-neutral-300 hover:text-white border border-[#2a2a2a] rounded-lg transition-colors flex items-center justify-center gap-2">
                                Privacy Settings
                            </button>
                        </div>
                    </div>
            ...
            <PageWidget title="Your Signed Agreements" icon={FileText}>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-[#222] text-sm">
                            {signedAgreements.map((doc) => (
                                <tr key={doc.id} className="group hover:bg-[#161616] transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <div className="flex items-center gap-2">
                                                <span className="text-neutral-200 font-medium">{doc.name}</span>
                                                {doc.type === 'Compliance' && (
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="text-xs font-mono text-neutral-500 bg-[#1a1a1a] px-2 py-1 rounded border border-[#2a2a2a]">
                                            v{doc.version}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 text-right">
                                        <button 
                                            ...
                                            className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-neutral-400 hover:text-white bg-transparent hover:bg-[#222] border border-transparent hover:border-[#333] rounded-lg transition-all"
                                        >
                                            {downloading === doc.id ? (
                ...
                {/* Audit Footer */}
                <div className="mt-6 pt-4 border-t border-[#222] flex items-center justify-between text-[11px] text-neutral-600">
                    <div className="flex items-center gap-2">
            ...
            <div className="flex items-start gap-4 p-4 rounded-xl bg-[#161616] border border-[#222]">
                <AlertCircle className="w-5 h-5 text-neutral-500 mt-0.5 shrink-0" />
                <div>
                    <h4 className="text-sm font-medium text-neutral-300 mb-1">Legal Disclaimer</h4>
