            ...
            <main className="flex-1 flex flex-col h-full ml-64 relative bg-[#0E0E10] light:bg-gray-50">
                ...
                <div className="flex-none h-14 px-6 border-b border-[#27272A] light:border-gray-200 flex items-center justify-between bg-[#0E0E10] light:bg-white z-20">
                    ...
                    <div className="flex items-center gap-2">
                        <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#18181B] light:bg-gray-100 border border-[#27272A] light:border-gray-200 ${isTokenLocked ? 'border-red-900/50' : ''}`}>
                        ...
                        <div className="flex-1 overflow-y-auto p-2 space-y-1 custom-scrollbar">
                            ...
                            {groups.map(group => (
                                <div key={group.id} className="mb-1 relative">
                                    ...
                                    <div
                                        className={`group/header flex items-center justify-between px-2 py-1.5 rounded-md cursor-pointer select-none transition-colors ${draggingId ? 'border border-dashed border-zinc-700 light:border-gray-300 bg-[#18181B] light:bg-gray-100' : 'hover:bg-[#18181B] light:hover:bg-gray-200'}`}
                        ...
                        <div ref={chatContainerRef} className="flex-1 overflow-y-auto px-4 md:px-12 lg:px-24 py-8 space-y-8 scroll-smooth pb-40">
                            {messages.length === 0 && (
                                <div className="h-full flex flex-col items-center justify-center text-zinc-500 light:text-gray-400 select-none pb-20">
                                    ...
                                    <h2 className="text-xl font-medium text-zinc-200 light:text-black mb-2">How can I help you today?</h2>
                                                    ...
                                                    <div className="prose prose-invert max-w-none">
                                                        <ReactMarkdown
                                                            ...
                                                            components={{
                                                                ...
                                                                thead({ children }: any) {
                                                                    return (
                                                                        <thead className="bg-[#18181B] light:bg-gray-100 text-xs uppercase font-semibold text-zinc-500 light:text-gray-700 border-b border-[#27272A] light:border-gray-200">
                                                                            {children}
                                                                        </thead>
                                                                    );
                                                                },
                                                                tbody({ children }: any) {
                                                                    return (
                                                                        <tbody className="divide-y divide-[#27272A] light:divide-gray-200 bg-transparent">
                                                                            {children}
                                                                        </tbody>
                                                                    );
                                                                },
                                                                tr({ children }: any) {
                                                                    return (
                                                                        <tr className="transition-colors hover:bg-white/5 light:hover:bg-gray-50 group/row">
                                                                            {children}
                                                                        </tr>
                                                                    );
                                                                },
                                                                ...
                                                                td({ children }: any) {
                                                                    return (
                                                                        <td className="px-4 py-3 align-top leading-relaxed text-zinc-300 light:text-gray-700">
                                                                            {children}
                                                                        </td>
                                                                    );
                                                                }
