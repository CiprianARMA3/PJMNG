            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <button 
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[#27272A]/50 hover:bg-[#27272A] rounded-md text-xs text-zinc-400 hover:text-zinc-200 transition-colors border border-transparent hover:border-zinc-700"
                >
                      ...
                      {models.map((model) => {
                        ...
                        return (
                          <button 
                            ...
                            className="w-full flex items-center justify-between px-3 py-2 text-sm text-left text-zinc-400 hover:bg-[#27272A] hover:text-zinc-100 transition-colors"
                          >
