                    ...
                    <div className="flex items-center justify-between px-3 pb-3 pt-1">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="relative">
                                <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[#27272A]/30 light:bg-gray-100 rounded-md text-xs text-zinc-500 light:text-gray-500 cursor-default border border-transparent">
