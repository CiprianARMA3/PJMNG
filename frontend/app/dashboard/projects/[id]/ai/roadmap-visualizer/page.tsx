...
const CustomRoadmapNode = ({ data }: any) => {
    ...
    let colorClass = "text-zinc-400 light:text-gray-600";
    let bgBorderClass = "border-zinc-700 bg-zinc-900 light:bg-white light:border-gray-300";
    ...
    return (
        <div className={`px-4 py-3 rounded-md border shadow-2xl min-w-[200px] backdrop-blur-md ${bgBorderClass} transition-all duration-300 hover:border-zinc-500 light:hover:border-gray-400 hover:shadow-zinc-500/10 hover:-translate-y-1`}>
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    <div className="text-[13px] font-bold text-zinc-100 light:text-black leading-tight mb-1 tracking-tight">{data.label}</div>
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-mono text-zinc-500 light:text-gray-500 uppercase tracking-wider">{data.timeline}</span>
                    </div>
                </div>
            </div>
...
const RoadmapGraph = ({ rawData }: { rawData: any[] }) => {
    ...
    const GraphContent = (
        <div
            className={`
                bg-[#0e0e10] light:bg-gray-50 overflow-hidden group/graph
                ${isFullscreen
                    ? "fixed inset-0 z-[99999] w-screen h-screen"
                    : "relative h-[500px] w-full rounded-xl border border-[#27272A] light:border-gray-200 shadow-2xl shadow-black/40 light:shadow-gray-200/50"
                }
            `}
        >
            <div className="absolute top-4 left-4 z-10 px-3 py-1 bg-[#18181B] light:bg-white border border-[#27272A] light:border-gray-200 rounded-full text-[10px] font-bold text-zinc-500 light:text-gray-500 uppercase tracking-widest pointer-events-none shadow-lg backdrop-blur-md">
                Interactive Roadmap
            </div>

            <button
                onClick={() => setIsFullscreen(!isFullscreen)}
                className="absolute top-4 right-4 z-10 p-2 bg-[#18181B] light:bg-white border border-[#27272A] light:border-gray-200 rounded-lg text-zinc-400 light:text-gray-500 hover:text-white light:hover:text-black hover:bg-[#27272A] light:hover:bg-gray-100 transition-colors shadow-lg backdrop-blur-md"
            ...
            >
                ...
                <Controls
                    ...
                    className="
                        !bg-[#18181B] light:!bg-white
                        !border
                        !border-[#27272A] light:!border-gray-200
                        !rounded-lg 
                        !shadow-xl 
                        !m-4
                        [&_button]:!bg-[#18181B] light:[&_button]:!bg-white
                        [&_button]:!border-b-[#27272A] light:[&_button]:!border-b-gray-200
                        [&_button]:!transition-colors
                        [&_button_svg]:!fill-zinc-400 light:[&_button_svg]:!fill-gray-500
                        [&_button_path]:!fill-zinc-400 light:[&_button_path]:!fill-gray-500
                        [&_button:hover]:!bg-[#27272A] light:[&_button:hover]:!bg-gray-100
                        [&_button:hover_svg]:!fill-white light:[&_button:hover_svg]:!fill-black
                        [&_button:hover_path]:!fill-white light:[&_button:hover_path]:!fill-black
    ...
    if (isFullscreen && mounted) {
        return (
            <>
                <div className="h-[500px] w-full border border-[#27272A]/30 light:border-gray-200 rounded-xl bg-[#0e0e10]/30 light:bg-gray-50/30 my-6 flex items-center justify-center dashed border-zinc-800 light:border-gray-300">
                    <div className="flex flex-col items-center gap-2 text-zinc-600 light:text-gray-400 animate-pulse">
                        <Maximize2 size={24} />
    ...
    return (
        <div
            ...
            className={`
                ...
                ${isActive ? 'bg-[#18181B] light:bg-gray-200 shadow-sm border border-[#27272A] light:border-gray-300' : 'hover:bg-[#18181B] light:hover:bg-gray-100 border border-transparent'}
        ...
        >
            <div className="flex items-center gap-2.5 flex-1 min-w-0">
                ...
                {isEditing ? (
                    <input
                        ...
                        className="bg-transparent text-xs text-white light:text-black border-none outline-none w-full"
                    />
                ) : (
                    <span
                        onDoubleClick={(e) => { e.stopPropagation(); onEdit(chat.id); setEditValue(chat.title); }}
                        className={`truncate text-xs transition-colors duration-300 ${isActive ? 'text-zinc-200 light:text-black font-medium' : 'text-zinc-500 light:text-gray-500 group-hover:text-zinc-300 light:group-hover:text-black'}`}
                    >
            ...
            <div className="flex items-center gap-2 pl-2 ml-4 flex-shrink-0">
                ...
                <button
                    onClick={onDelete}
                    className={`
                        p-1 hover:bg-[#27272A] light:hover:bg-gray-200 rounded text-zinc-500 light:text-gray-400 hover:text-red-400 
...
export default function AiAssistantPage({ params }: PageProps) {
    ...
    return (
        <div className="h-screen bg-[#0E0E10] light:bg-gray-50 text-[#E1E1E3] flex overflow-hidden font-sans selection:bg-zinc-700 selection:text-white">
            <style jsx global>{`
                ...
                <div className="flex flex-1 h-full overflow-hidden">
                    ...
                    <div className="w-[300px] bg-[#09090B] light:bg-gray-50 border-r border-[#27272A] light:border-gray-200 flex flex-col flex-shrink-0">
                        <div className="p-3 border-b border-[#27272A] light:border-gray-200 flex items-center gap-2">
                            <button onClick={() => handleNewChat(null)} className="flex-1 flex items-center justify-center gap-2 bg-[#FAFAFA] light:bg-white text-black light:text-gray-700 hover:bg-white light:hover:bg-gray-50 transition-colors py-1.5 rounded-md text-xs font-semibold shadow-sm light:shadow-sm light:border light:border-gray-200 tracking-wide">
                        ...
                        <div className="flex-1 overflow-y-auto p-2 space-y-1 custom-scrollbar">
                            ...
                            {groups.map(group => (
                                <div key={group.id} className="mb-1 relative">
                                    {/* Group Header */}
                                    <div className={`group/header flex items-center justify-between px-2 py-1.5 rounded-md cursor-pointer select-none transition-colors ${draggingId ? 'border border-dashed border-zinc-700 bg-[#18181B] light:bg-gray-100 light:border-gray-300' : 'hover:bg-[#18181B] light:hover:bg-gray-200'}`} onClick={() => toggleGroup(group.id)} onDragOver={(e) => e.preventDefault()} onDrop={(e) => handleDrop(e, group.id)}>
                                        <div className="flex items-center gap-2 overflow-hidden text-zinc-400 light:text-gray-500 group-hover/header:text-zinc-200 light:group-hover/header:text-black min-w-0 flex-1">
                            ...
                            <div className="pt-2 mt-2 border-t border-[#27272A]/50 light:border-gray-200">
                        ...
                        <div className="p-4 border-t border-[#27272A] light:border-gray-200 bg-[#0E0E10] light:bg-gray-50">
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-2 text-xs font-medium text-zinc-300 light:text-gray-700">
                                ...
                                <span className={`text-xs font-mono ${selectedModelBalance > 0 ? 'text-zinc-400 light:text-gray-500' : 'text-red-500'}`}>
                                    {selectedModelBalance.toLocaleString()}
                                    &nbsp;tokens
                                </span>
                            </div>
                            <div className="h-1.5 w-full bg-[#18181B] light:bg-gray-200 rounded-full overflow-hidden border border-[#27272A] light:border-gray-300">
                                <div
                                    className={`h-full rounded-full transition-all duration-500 ${selectedModelBalance > 250000
                    ...
                    <div className="flex-1 flex flex-col relative min-w-0 bg-[#0E0E10] light:bg-white" onClick={() => setActiveTagMenuId(null)}>
                        <div ref={chatContainerRef} className="flex-1 overflow-y-auto px-4 md:px-12 lg:px-24 py-8 space-y-8 scroll-smooth pb-40">
                            {messages.length === 0 && (
                                <div className="h-full flex flex-col items-center justify-center text-zinc-500 light:text-gray-400 select-none pb-20">
                                    ...
                                    {/* Main Title */}
                                    <h2 className="text-xl font-medium text-zinc-200 light:text-black mb-2">
                                    ...
                                    <div className="w-full max-w-xs bg-[#18181B] light:bg-gray-50 border border-[#27272A] light:border-gray-200 rounded-xl p-5 text-left shadow-lg shadow-black/10 light:shadow-gray-200/50 backdrop-blur-sm">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {/* Tip 1: Project Type */}
                                            <div>
                                                <p className="text-xs text-zinc-500 light:text-gray-500 font-medium mb-1.5 flex items-center gap-1.5">
                                                ...
                                                <div className="flex flex-wrap gap-1.5">
                                                    {[
                                                        ...
                                                        <span
                                                            key={type}
                                                            className="px-1.5 py-0.5 rounded bg-[#27272A] light:bg-gray-200 border border-white/5 light:border-gray-300 text-[10px] text-zinc-300 light:text-gray-700 font-mono hover:bg-[#323238] light:hover:bg-gray-300 transition-colors cursor-default">
                                                            {type}
                                                        </span>
                                                    ))}
                                                </div>
                                            ...
                                            {/* Tip 2: Context */}
                                            <div>
                                                <p className="text-xs text-zinc-500 light:text-gray-500 font-medium mb-1">
                                                    2. Provide Context
                                                </p>
                                                <p className="text-xs text-zinc-400 light:text-gray-600 leading-relaxed">
                                                        ...
                                                        <ReactMarkdown
                                                            ...
                                                            components={{
                                                                ...
                                                                table: ({ node, children }: any) => {
                                                                    ...
                                                                    return (
                                                                        <div className="my-6 w-full overflow-hidden rounded-lg border border-[#27272A] light:border-gray-200 shadow-sm light:shadow-gray-200/50">
                                                                            <div className="overflow-x-auto">
                                                                                <table className="w-full text-left text-sm text-zinc-300 light:text-gray-700">
                                                                                    {children}
                                                                                </table>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                thead({ children }: any) { return <thead className="bg-[#18181B] light:bg-gray-100 text-xs uppercase font-semibold text-zinc-500 light:text-gray-700 border-b border-[#27272A] light:border-gray-200">{children}</thead>; },
                                                                tbody({ children }: any) { return <tbody className="divide-y divide-[#27272A] light:divide-gray-200 bg-transparent">{children}</tbody>; },
                                                                tr({ children }: any) { return <tr className="transition-colors hover:bg-white/5 light:hover:bg-gray-50 group/row">{children}</tr>; },
                                                                th({ children }: any) { return <th className="px-4 py-3 whitespace-nowrap tracking-wider">{children}</th>; },
                                                                td({ children }: any) { return <td className="px-4 py-3 align-top leading-relaxed text-zinc-300 light:text-gray-700">{children}</td>; }
                                                            }}
                                                        >
                                                            {msg.content}
                                                        </ReactMarkdown>
