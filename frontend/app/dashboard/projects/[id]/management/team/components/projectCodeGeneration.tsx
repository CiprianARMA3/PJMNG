    ...
    <div className="w-full  rounded-lg p-1 mb-6">
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          className="group flex items-center gap-1.5 text-[10px] text-zinc-500 hover:text-zinc-300 transition-colors disabled:opacity-50"
      ...
      <div className="flex gap-2">
        <div className="relative flex-1 group">
            <input 
              ...
              className="w-full bg-black/40 border border-zinc-800 text-zinc-400 text-xs rounded-md px-3 py-2.5 font-mono focus:outline-none focus:ring-1 focus:ring-zinc-700 select-all"
            />
        ...
        <button
          onClick={handleCopy}
          className="flex items-center justify-center px-3 bg-zinc-100 hover:bg-white text-black rounded-md transition-colors active:scale-95"
