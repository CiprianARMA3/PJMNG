                ...
                <div className="bg-[#0C0C0E] border border-zinc-800 p-5 rounded-xl relative overflow-hidden group/credits z-10 flex flex-col justify-between h-full">
                  ...
                  <div>
                    ...
                    <div className="mt-4 pt-4 border-t border-zinc-800/30">
                      <p className="text-zinc-500 text-xs uppercase font-bold tracking-widest mb-1">Total Spent</p>
                        ...
                        {transactions.length > 0 ? (
                          transactions.map((transaction, index) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex items-center gap-2">
                                  <span className="inline-flex items-center px-2 py-1 rounded-md bg-zinc-900/50 text-xs font-medium text-zinc-300 border border-zinc-800">
