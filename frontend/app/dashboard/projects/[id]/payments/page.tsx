...
export default function TokenManagementPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-100 font-sans flex justify-center pb-20">
      <div className="w-full max-w-5xl px-6 py-12">
        ...
        <div className="mb-10 border-b border-zinc-800 pb-6 flex justify-between items-end">
          <div>
            ...
            <p className="text-zinc-400 text-sm">Select a model and a token pack to refill your project.</p>
          </div>
          {isEnterprise && (
            <div className="px-3 py-1 bg-purple-500/10 border border-purple-500/30 rounded text-purple-400 text-xs font-bold uppercase tracking-wide">
              Enterprise Pricing
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-8">
            {/* Model Selector */}
            <section>
              <h3 className="text-sm font-bold text-zinc-500 uppercase tracking-wider mb-4">1. Select Model</h3>
                ...
                {MODELS.map((model) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <Sparkles size={16} className={selectedModel === model.key ? "text-indigo-400" : "text-zinc-600"} />
            ...
            {/* Pack Selector */}
            <section>
              <h3 className="text-sm font-bold text-zinc-500 uppercase tracking-wider mb-4">2. Choose Amount</h3>
                    ...
                    <button
                      ...
                      className={`relative p-5 rounded-xl border transition-all group ${
                        selectedPackIndex === idx
                          ...
                          : "bg-[#0C0C0E] border-zinc-800 hover:border-zinc-600"
                      }`}
                    >
                      ...
                      <div className={`text-sm font-medium ${selectedPackIndex === idx ? "text-zinc-600" : "text-zinc-400"}`}>
                        €{pack.displayPrice}
                      </div>
                      {selectedPackIndex === idx && (
            ...
            <div className="sticky top-10">
              <div className="bg-[#0C0C0E] border border-zinc-800 rounded-xl p-6 shadow-2xl">
                <h3 className="text-white font-bold mb-6 flex items-center gap-2">
                  <ShoppingBag size={18} className="text-zinc-400"/> Order Summary
                </h3>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                      <div>
                        ...
                        <div className="text-xs text-zinc-500">{formatTokens(currentPack.amount)} Tokens</div>
                      </div>
                      <div className="font-mono text-zinc-200">€{currentPack.displayPrice}</div>
                    </div>
