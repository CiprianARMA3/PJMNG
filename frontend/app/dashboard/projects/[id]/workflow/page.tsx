...
export default function WorkflowPage() {
  ...
  if (loading) return <div className="h-screen bg-[#0a0a0a] flex items-center justify-center text-white/20">Loading Schedule...</div>;
                                             ...
                                             {dayTasks.map(task => {
                                                 ...
                                                 return (
                                                     ...
                                                     >
                                                         ...
                                                         <div className="flex flex-col pr-24 pt-0.5"> 
