      ...
      <main className="flex-1 ml-64 min-h-screen overflow-y-auto bg-[#0a0a0a] light:bg-gray-50">
        <div className="mx-auto pt-16">
          ...
          {ownerStatus && !ownerStatus.active && (
            <div className="bg-red-900/20 light:bg-red-50 border-b border-red-500/20 light:border-red-200 px-8 py-4 flex items-center justify-between backdrop-blur-md sticky top-0 z-50">
              <div className="flex items-center gap-3 text-red-400 light:text-red-800">
                <AlertTriangle size={20} className="text-red-500 light:text-red-600" />
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent light:from-gray-50 light:via-gray-50/80 p-8">
              <div className="flex items-end gap-6">
                {project.metadata?.["project-icon"] ? (
                  <img src={project.metadata["project-icon"]} alt="Logo" className="w-24 h-24 rounded-3xl border-4 border-[#0a0a0a] light:border-gray-50 object-cover shadow-2xl bg-[#161616] light:bg-white -mb-4" />
                ) : (
                ...
                <div className="-mb-2">
                  <h1 className="text-4xl font-extrabold text-white light:text-black tracking-tight mb-1">{project.name}</h1>
                  <p className="text-white/70 light:text-gray-600 text-base max-w-2xl line-clamp-2">{project.description || "No description provided."}</p>
                </div>
              </div>
            </div>
          </div>
